...
export const ColumnsUsuarios = (createUsuario, setUpdate, update, addOrEdit, setCreateUsuario, deleteUsuario, setTrash, trash, onDelete, setDeleteUsuario, roles, language) => [
  { field: "nombreCompleto" , headerName: t("NOMBRE"), flex: 0.4 , valueGetter: (params) =>  `${params.row.nombres + ' ' + params.row.apellidos}`}, 
  { field: "numeroDocumento" , headerName: t("NUMERODOCUMENTO"), flex: 0.2}, 
